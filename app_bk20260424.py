...
@app.post("/improve")
def improve_api(data: LoanInput):
    try:
        result = improver.improve(data.model_dump())
        return {
            "status": "success",
            **result
        }
...
@app.post("/suggest")
def suggest_api(data: LoanInput):
    try:
        result = run_suggest(data.model_dump())
        return {
            "status": "success",
            **result
        }
