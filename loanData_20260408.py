...
csv_file = r'C:\Python_Project\Loan_Data\loan_final313_mod.csv'
data = pd.read_csv(csv_file, low_memory=False)

data1=data.drop(['id','year','loan_condition_cat','application_type','home_ownership_cat','application_type_cat','issue_d'], axis=1)
data1=data1.dropna(subset=['loan_condition'])
joblib.dump(data, r"C:\Python_Project\Loan_Data\dice_data.pkl")
#data = data.drop('grade_cat', axis=1)
X = data1.drop('loan_condition', axis=1)
y = data1['loan_condition']
